<template>
  <FluidContainer class="space-y-4 flex flex-col my-0">
    ...
    <div>
      <h2 class="text-lg text-gray-500 dark:text-dark-fg">Your Personal Token</h2>
      <pre class="cli-box">{{ token }}</pre>
    </div>

    <div>
      <h2 class="text-lg text-gray-500 dark:text-dark-fg">Shell setup</h2>
      <pre class="cli-box">{{ usageWithShell }}</pre>
    </div>

    <div>
      <h2 class="text-lg text-gray-500 dark:text-dark-fg">Example API Usage</h2>
      <pre class="cli-box">{{ usageWithCurl }}</pre>
    </div>

    <div>
      <div class="flex items-center">
        <h2 class="text-lg text-gray-500 dark:text-dark-fg">Example CLI Usage</h2>
