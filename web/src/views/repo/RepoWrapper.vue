<template>
  <FluidContainer v-if="repo && repoPermissions && $route.meta.repoHeader">
    <div class="flex flex-wrap border-b items-center pb-4 mb-4 dark:border-gray-600 justify-center">
      <h1 class="text-xl text-gray-500 dark:text-dark-fg w-full md:w-auto text-center mb-4 md:mb-0">
      ...
      <a
        :href="repo.link_url"
        target="_blank"
        class="flex ml-4 p-1 rounded-full text-gray-500 dark:text-dark-fg
			hover:bg-gray-200 hover:text-gray-700 dark:hover:text-dark-fg dark:hover:bg-gray-600"
      >
