  ...
  <template v-if="build && repo">
    <FluidContainer class="flex flex-col min-w-0 border-b dark:border-gray-600 !pb-0 mb-4">
      <div class="flex mb-2 items-center <md:flex-wrap">
        ...
        <h1
          class="
            ...
            flex
            text-center text-xl text-gray-500 dark:text-dark-fg
            whitespace-nowrap
      ...
      <div class="flex flex-wrap gap-y-2 items-center justify-between">
        ...
        <div class="flex justify-between gap-x-4 text-gray-500 dark:text-dark-fg flex-shrink-0 pb-2 md:p-0 mx-auto md:mr-0">
