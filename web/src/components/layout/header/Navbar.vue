<template>
  <div class="flex shadow-lg bg-lime-600 text-neutral-content px-2 md:px-8 py-2 dark:bg-dark-gray-900">
    <div class="flex text-white dark:text-dark-fg items-center">
      <router-link :to="{ name: 'home' }" class="relative">
        <img class="w-12" src="../../../assets/logo.svg?url" />
    ...
    <div class="flex ml-auto items-center space-x-4 text-white dark:text-dark-fg">
      <a
        :href="docsUrl"
        target="_blank"
      ...
      <IconButton
        ...
        class="!text-white !dark:text-dark-fg"
